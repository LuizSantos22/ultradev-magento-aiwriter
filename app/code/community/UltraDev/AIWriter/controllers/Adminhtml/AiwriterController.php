...
class UltraDev_AIWriter_Adminhtml_AiwriterController extends Mage_Adminhtml_Controller_Action
{
    ...
    public function generateAction()
    {
        ...
        try {
            ...
            // Contexto técnico extra via Exa (opcional — null se desativado ou se falhar,
            // e nesse caso o fluxo segue normalmente como antes desta integração).
            $extraContext = Mage::helper('ultradev_aiwriter/exa')->fetchContext($productName);
            // Monta e envia prompt
            $prompt   = Mage::helper('ultradev_aiwriter/prompt')->build($productName, $reference, $extraContext);
